...
public class RecipeDraft
{
    ...
    [JsonPropertyName("calories_per_serving")] public int CaloriesPerServing { get; set; }
    [JsonPropertyName("protein_g")]    public int ProteinG { get; set; }
    [JsonPropertyName("carbs_g")]      public int CarbsG { get; set; }
    [JsonPropertyName("fat_g")]        public int FatG { get; set; }
...
public class IngredientDraft
{
    ...
    [JsonPropertyName("calories_per_unit")] public int CaloriesPerUnit { get; set; }
}
